...
//try form class (database connection, table name, parameters, sticky fields);
$Form = new Form($db, 'dzpro_user_data');

//show foreign tables
//$Form->showForeignTablesWithPrimaryKey();

//whitelist foreign table with primary key .. input array
$Form->whitelistForeignTables(array('dzpro_user_meta'));
