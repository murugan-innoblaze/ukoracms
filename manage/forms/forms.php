...
//try form class
$Form = new Form($db, 'dzpro_forms', array('states' => $states_list));

//blacklist identities
//$Form->blackListAssociativeTables(array('dzpro_identities'));
...
$Form->whitelistForeignTables(array('dzpro_form_fields'));
?>
<!DOCTYPE html> 
<html lang="en-us"> 
	<head> 
