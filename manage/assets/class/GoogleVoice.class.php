...
class GoogleVoice {
    ...
    public function __construct($username, $password){
		...
		if(!preg_match('/gmail\.com/i', $username)){ $this->inboxURL = 'https://www.google.com/voice/b/0/m/'; }
    }
    ...
    public function getLoginAuth(){
        $login_param = "accountType=HOSTED_OR_GOOGLE&Email={$this->username}&Passwd={$this->password}&service=grandcentral&source=com.lostleon.GoogleVoiceTool";
